...
<body>
	...
	<div class="banner">
		<div class="conten">Calidad|Seguridad|Servicio <br>
			<small>Obra civil y Arquitectura</small>
			<div class="botonc">
  ...
  <p class="text">Somos una empresa comprometida con nuestros cliente por medio del uso de los mejores recursos humanos y tecnológicos.</p>

  <div class="section seccion1">
      <div class="container">
      <div class="col-md-12">
            <h1 class="text-center h1-index" style="color: #1D4C7C;">Algunos de nuestros servicios</h1> <br><br>
        ...
        <div class="row">
          <div class="col-sm-4 col-md-4">
            ...
            <h2 class="text-center text-primary text-newstyle">Edificación</h2>
          ...
          <div class="col-sm-4 col-md-4 margen-top">
            <img src="img/0202.jpg"
            class="img-responsive">
            <h2 class="text-center text-primary text-newstyle">Instalaciones</h2>
          ...
          <div class="col-sm-4 col-md-4 margen-top">
            ...
            class="img-responsive">
            <h2 class="text-center text-primary text-newstyle">Acabados</h2>
